...
- A records point to IP addresses, CNAME points to another domain — use an A record for the root domain instead of a CNAME
...
- Subdomains are free and instant — use free subdomains for experiments instead of purchasing new domains for every project
