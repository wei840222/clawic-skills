...
### Within Austin
- **Rideshare is dominant** — Many first-time visitors can skip a rental if they stay central
...
- **Make sure to try gas station tacos** — Some are legendary

### BBQ Strategy
- **Franklin is excellent and slow** — commit fully (near-8am arrival, multi-hour wait) or skip the line
- **Strong alternatives**: la Barbecue, Micklethwait, Interstellar
- **Lower-line options**: Terry Black's and Stiles Switch are excellent without the pilgrimage wait
- **Order baseline**: Brisket (always), ribs, sausage; sides are secondary
...
## Planning Pitfalls and Better Defaults

### Higher-risk patterns
- **Packing the day with midday outdoor blocks in summer** — Heat exhaustion risk rises fast
- **Treating Austin like a compact walkable core** — Distances sprawl; check maps before walking plans
- **Skipping breakfast tacos entirely** — Easy cultural miss for first-timers
- **Only sampling Dirty 6th** — East 6th and Rainey usually fit better for many visitors
- **Defaulting onto I-35 at rush hour** — Build buffer or alternate corridors
- **Assuming “nearby” means 10 minutes** — Verify drive/walk time before committing

### Helpful defaults
- **Bring a reusable water bottle** — Hydration is baseline survival in heat
- **Reserve BBQ or commit to the line** — Famous spots punish ambivalence
- **Check event calendars first** — SXSW/ACL/F1 rewrite lodging and traffic
- **Ask locals for current picks** — Scene moves; pride is usually generous
- **Tip well** — Service industry carries the hospitality layer
...
- **Flash floods** — If it rains hard, stay clear of flooded roads
